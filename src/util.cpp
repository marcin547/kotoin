...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "kotoin.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No kotoin.conf file is OK
    ...
    {
        // Don't overwrite existing settings so command line settings override kotoin.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "kotoin.pid"));
