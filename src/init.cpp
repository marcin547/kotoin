    ...
    try
    {
        ...
        if (mapArgs.count("-?") || mapArgs.count("--help"))
        {
            ...
            std::string strUsage = _("SmallChange version") + " " + FormatFullVersion() + "\n\n" +
                _("Usage:") + "\n" +
                  "  kotoin [options]                     " + "\n" +
                  "  kotoin [options] <command> [params]  " + _("Send command to -server or kotoin") + "\n" +
                  "  kotoin [options] help                " + _("List commands") + "\n" +
                  "  kotoin [options] help <command>      " + _("Get help for a command") + "\n";
        ...
        for (int i = 1; i < argc; i++)
            if (!IsSwitchChar(argv[i][0]) && !boost::algorithm::istarts_with(argv[i], "kotoin:"))
                fCommandLine = true;
...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        "  -conf=<file>           " + _("Specify configuration file (default: kotoin.conf)") + "\n" +
        "  -pid=<file>            " + _("Specify pid file (default: kotoin.pid)") + "\n" +
...
//    }
    ...
    // Make sure only a single kotoin process is using the data directory.
    ...
    // requested to kill kotoin-qt during the last operation. If so, exit.
